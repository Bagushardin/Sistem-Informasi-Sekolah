...
// ==================== DASHBOARD ROUTES ====================
Route::middleware(['auth', 'role:admin'])->get('/admin/dashboard', [HomeController::class, 'admin'])->name('admin.dashboard');
Route::middleware(['auth', 'role:guru'])->get('/guru/dashboard', [HomeController::class, 'guru'])->name('guru.dashboard');
Route::middleware(['auth', 'role:siswa'])->get('/siswa/dashboard', [HomeController::class, 'siswa'])->name('siswa.dashboard');
Route::middleware(['auth', 'role:orangtua'])->get('/orangtua/dashboard', [HomeController::class, 'orangtua'])->name('orangtua.dashboard');
